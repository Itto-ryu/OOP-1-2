...
#For calculator
        ...
        self.txt10 = Entry(window, justify = "center")
        ...
        self.txt11 = Entry(window, justify = "center")
        self.txt11.grid(row = 5, column = 1, padx = 2, pady = 2)

        self.lbl3 = Label(window, text = "Choose the operator", font = ('Times New Roman', 10))
        self.lbl3.grid(row = 6, column = 0, sticky = W)

        self.btn1 = Button(window, text = "Add", command = self.add)
        self.btn1.grid(row = 6, column = 1, pady = 2)
        #self.btn1.bind('<Button-1>', self.add) #has event in def, coz of bind
        ...
        self.lbl4 = Label(window, text = "Results: ", font = ('Times New Roman', 10))
        self.lbl4.grid(row = 8, column = 0, sticky = E)
        self.txt12 = Entry(window, justify = "center")
